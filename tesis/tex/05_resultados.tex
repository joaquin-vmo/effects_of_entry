...
\begin{figure}[htbp]
    ...
    \includegraphics[width = \textwidth]{output/graficos/sunab_2012_2026.pdf}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/es_2012_2026_p93.tex}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width = \textwidth]{output/graficos/atenuacion_distancia.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width = \textwidth]{output/graficos/mercado.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width = \textwidth]{output/graficos/distribucion_beta.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width = \textwidth]{output/graficos/distribucion_acumulada.pdf}
