...
\begin{figure}[htbp]
    ...
    \includegraphics{output/graficos/estructura_precios.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics{output/graficos/serie_margen.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics{output/graficos/conley_2012_2026.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics{output/graficos/fischer_semanal.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics{output/graficos/het_autopista.pdf}
...
\begin{figure}[htbp]
    ...
    \includegraphics{output/graficos/persistencia.pdf}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/es_controles_p93.tex}
    \notacontroles
\end{table}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/es_controles_p97.tex}
    \notacontroles
\end{table}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/es_controles_pdi.tex}
    \notacontroles
\end{table}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/es_2012_2026_p97.tex}
    \notaes
\end{table}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/es_2012_2026_pdi.tex}
    \notaes
\end{table}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/het_autopista.tex}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/mercado.tex}
...
\begin{table}[htbp]
    ...
    \ajustar{\input{output/tablas/validacion_margen.tex}}
...
\begin{table}[htbp]
    ...
    \input{output/tablas/honest_principal.tex}
...
\begin{table}[htbp]
    ...
    \ajustar{\input{output/tablas/honest_mercado.tex}}
...
\begin{table}[htbp]
    ...
    \ajustar{\input{output/tablas/placebo_controles.tex}}
...
\begin{table}[htbp]
    ...
    \ajustar{\input{output/tablas/ventana_2014_2019.tex}}
...
\begin{table}[htbp]
    ...
    \ajustar{\input{output/tablas/ventana_2021_2026.tex}}
